		 	...
		 	<table class="table table-hover">
			    ...
			    <tbody>
			    	...
			    	$i=0;
					    ...
					    $fetch_words="SELECT * FROM dictionary where language='$language_id'";
			    	...
			    	?>
					      <tr>
					        ...
					        <?php if($flag=="not-favourite"){ ?>
					        	<td><a href="mark_favourite.php?word_id=<?php echo $word_id;  ?>">Mark Favourite</a></td>
					    	<?php }else{

					    		echo "<td>Favourite Word</td>";
					    	} ?>
					      </tr>
